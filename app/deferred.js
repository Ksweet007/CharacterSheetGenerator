define(function (require) {
    ...
    DeferredWrapper.prototype.waitForAll = function () {
        /// <summary>
        /// Custom method returns a new deferred. This new deferred will only reject once
        /// all of the provided deferreds have resolved or rejected. Once that happens
        /// the returned deferred will resolve if all passed deferred resolves and will
        /// reject if at least one of the passed deferreds rejected.
        /// If a null or undefined value is in the array, that will be treated the
        /// same as a resolved deferred.
        /// </summary>
